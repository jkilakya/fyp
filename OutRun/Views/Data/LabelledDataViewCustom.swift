...
class LabelledDataViewCustom: UIView, SmallStatView {
    ...
    init(title: String, measurementAndUnit: String) {
        super.init(frame: .zero)
        
        self.headlineLabel.text = title.uppercased()
        self.setData(for: measurementAndUnit)
    ...
    private func setData(for measurement: String?) {
...
//        let type = CustomMeasurementFormatting.FormattingMeasurementType(for: newValue.unit, asClock: true, asAltitude: isAltitude)
        self.informationLabel.text = measurement
